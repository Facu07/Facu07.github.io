class PlataformaHeli{
	...
	constructor(){
		...
		this.plataformaHeli.setPosicion(5,1.7,5)
		//this.plataformaHeli.setEscala(10,10,10)
		this.plataformaHeli.initTexture("img/helipad.jpg");
		this.tapaPlataformaHeli1 = new Objeto3D(crearGeometria(new Plano(1,1), filas, columnas, true));
		...
		this.tapaPlataformaHeli2 = new Objeto3D(crearGeometria(new Plano(1,1), filas, columnas, true));
		...
		this.tapaPlataformaHeli3 = new Objeto3D(crearGeometria(new Plano(1,1), filas, columnas, true));
		...
		this.tapaPlataformaHeli4 = new Objeto3D(crearGeometria(new Plano(1,1), filas, columnas, true));
