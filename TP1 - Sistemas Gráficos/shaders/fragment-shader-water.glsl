 precision mediump float;
        ...
        void main(void) {
            ...
            float alfa=0.08*atan(vectorReflectado.y/vectorReflectado.x);
            float beta=0.08*acos(vectorReflectado.z/r);
            
            vec3 colorRefleccion = texture2D(uSamplerReflectionMap, vec2(alfa, beta)).xyz*0.5;
