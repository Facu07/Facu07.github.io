...
//var controlF = [[0,0,0], [-1,0,0], [0,1,0], [1,0,0]];

var controlR = [[0,0,0], [0,0,1], [0,0,3], [0,0,4]];
//var controlR = [[3,0,0], [3,0,3], [-3,0,-3], [0,0,0]];

//var controlR = [[3,0,0], [3,0,3], [0,0,3], [0,0,0]];
//var controlR = [[0,0,0], [0.75,0,1], [2.25,0,-1], [3,0,0]];
...
function dibujarGeometria(mallaDeTriangulos){
